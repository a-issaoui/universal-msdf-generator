  ...
  try {
    ...
    if (result.success && !result.cached) {
      ...
      if (fontMeta) {
        console.log('\nDecompression Stats:');
        console.log(
          `- Format: ${fontMeta.originalFormat || 'unknown'} -> ${fontMeta.wasConverted ? 'TTF (decompressed)' : 'native'}`,
        );
